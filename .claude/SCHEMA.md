...
read	boolean not null default false	binary unread/read toggle shown as a checkbox per row on `/saves` (DECISIONS.md D-017). Not present in the original ask — added 2026-08-09 alongside per-row delete.
